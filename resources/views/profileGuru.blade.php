...
<body style="background-color: #2a9d8f;">
    <div class="container rounded-top" style="background-color:#2a9d8f; height:30%; width:100%; border-color:#2a9d8f;">
        <img src="{{asset($data->foto_guru)}}" class="rounded-circle mx-auto d-block p-3 img-fluid" width="90%;">
        <div class="container pb-3" style="background-color:#2a9d8f; text-align:center; color:white; border-color:#2a9d8f;">
            <h1>{{$data->nama}}</h1>
            <small style="color:white;">{{$data->email}}</small>
        </div>
    </div>
    <div class="container pb-4" style="background-color:white; border-radius : 7%;">
        <!-- <div class="row">
        <div class="col-sm">
